	...
	<div class="box">
		...
		<div class="box-body">
			<div style="margin-bottom: 20px;">
				<a href="<?php echo base_url('pendaftaranpasien/add'); ?>"><button type="button" class="btn btn-box btn-primary"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</button></a>
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $row->provinsi; ?></td>
							 ...
							 <td>
								<a href="<?php echo base_url('pendaftaranpasien/edit/' . $row->id); ?>"><button class="btn btn-warning"><i class="fa fa-pencil"></i></button></a>
								<a href="<?php echo base_url('pendaftaranpasien/cetak/'. $row->id); ?>"><button class="btn btn-print"><i class="fa fa-print"></i></button></a>
								<a href="<?php echo base_url('pendaftaranpasien/delete/'. $row->id); ?>"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
