       ...
       <!--  <div class="col-lg-12" > -->
          ...
          <div class="large-box bg-green" style="height: 500px;">
            ...
            <div class="inner">
              ...
              <br>
              <br>
                <sup style="font-size: 50px">HEMODIALISA</sup>
                <h3><p style="font-size: 200px;"><?php echo $jumlahpolihemodialisa; ?> </p>
                <p>PASIEN</p>
              </h3>
              </br>
...
<form method="post">
  ...
  <a href="<?php echo base_url('Pendaftaranpasien/index/hemodialisa'); ?>" class="btn btn-info" role="button">Lihat Pasien</a>
