...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>RSI</b>s</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SISPOLI</b> RSI </span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="<?php echo base_url(); ?>assets/template/"  class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo base_url(); ?>assets/template/" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>assets/template/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">SISTEM ANTRIAN POLI</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <!-- <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url(); ?>assets/template/">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url(); ?>assets/template/">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url(); ?>assets/template/">Friends</a>
                  </div>
                </div> -->
                <!-- /.row -->
              <!-- </li> -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('users/edit/1'); ?> "class="btn btn-default btn-flat">Profile</a>
                </div>
          ...
          <li>
            <a href="<?php echo base_url(); ?>assets/template/" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
